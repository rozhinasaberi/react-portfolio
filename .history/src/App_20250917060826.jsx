      ...
      <header id="header" className="fixed-top">
        <nav className="navbar container">
          ...
          <a href="#home" className="navbar-brand d-flex align-items-center gap-2">
            <img src="src/assets/logo.png" alt="Rojina Logo" style={{ height: 40 }} />
          ...
          <ul className="nav ms-auto">
            ...
            <li className="nav-item"><a className="nav-link" href="#Projectsection">Projects</a></li>
...
<section id="about" className="aboutsection about-stack">
  <div className="container">
    <div className="about-stack-inner">
      {/* Photo TOP */}
      <img src="src/assets/photo.jpg" alt="Rojina" className="hero-photo" />
