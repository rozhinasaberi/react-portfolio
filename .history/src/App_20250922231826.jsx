        ...
        <div className="container h-100">
          <div className="row h-100 hero-row">
            <div className="container">
              ...
              <p className="lead">
                Hi, Im <strong>Rojina Saberi</strong>. I want to contribute my abilities to a forward thinking firm that values innovation, cooperation, and growth.
              </p>
      ...
      <section id="about" className="aboutsection about-stack">
        <div className="container">
          ...
          <div className="about-container">
            ...
            <a href="/Rojina-Saberi.pdf" className="btn-visitpage" target="_blank" rel="noreferrer">
              Resume
            </a>
          </div>
        </div>
