...
export default function App() {
  return (
    ...
    <p className="lead">
      Hi, I’m <strong>Rojina Saberi</strong>. I’m passionate about software development and IT solutions.
    </p>
    <p className="mission">
...
<section id="about" className="aboutsection about-stack">
  <div className="container">
    ...
    <div className="about-container">
      <h2>
        A results-oriented IT professional, trained in object-oriented programming 
      ...
      <div className="col-lg-4 col-md-6">
        <div className="card project-card">
          ...
          <div className="card-body">
            ...
            <a href="./assets/bloodbank.pdf" className="btn btn-visitpage">Download Project</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="card project-card">
          ...
          <div className="card-body">
            ...
            <a href="./assets/mcdonalds.pdf" className="btn btn-visitpage">Download Report</a>
          </div>
        </div>
      </div>
    </div>
