        ...
        <div className="container h-100">
          <div className="row h-100 hero-row">
            <div className="container">
              ...
              <p className="lead">
                Hi, I’m <strong>Rojina Saberi</strong>. I want to contribute my abilities to a forward-thinking firm that values
                innovation, cooperation, and growth.
              </p>
              <p className="mission">
                My mission is to leverage technology to create impactful, efficient, and meaningful digital experiences.
              </p>
        ...
        <div className="container">
          ...
          <div className="about-container">
            <h2>
              ...
              technology from York University and hands-on expertise gained through a high-impact internship at Green Infrastructure Partners,
              I provide a unique combination of academic knowledge and practical experience. I am an expert in Microsoft 365, Active Directory,
              Intune, and network support, and I specialize at translating technical issues into clear, effective solutions for customers.
              I am known for my flexibility, communication skills, and enthusiasm for continuous development, and I am dedicated to improving
              operational efficiency and providing safe, efficient IT infrastructure.
            </h2>
            <p>
            ...
            <a href="/Rojina-Saberi.pdf" className="btn-visitpage" target="_blank" rel="noreferrer">Resume</a>
          </div>
        </div>
      </section>
          ...
          <div className="row g-3">
            <div className="col-md-3">
              <div className="text-box">
                <h4>Technical Support &amp; Helpdesk</h4>
                <p>Friendly, fast resolution for laptops, apps, accounts, and onboarding.</p>
                <ul>
            ...
            <div className="col-md-3">
              <div className="text-box">
                ...
                <p>Keep org systems healthy and compliant across users and devices.</p>
                <ul>
            ...
            <div className="col-md-3">
              <div className="text-box">
                ...
                <p>Stable connectivity with strong identity, access, and endpoint protection.</p>
                <ul>
            ...
            <div className="col-md-3">
              <div className="text-box">
                <h4>Data &amp; Cloud</h4>
                <p>Backups, BI, and cloud services to keep your data useful and safe.</p>
                <ul>
            ...
            <div className="col-md-3">
              <div className="text-box">
                ...
                <p>From scripts to web apps with clean APIs and secure data access.</p>
                <ul>
            ...
            <div className="col-md-3">
              <div className="text-box">
                ...
                <p>Clear docs and Agile habits so teams move quickly and consistently.</p>
                <ul>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card project-card">
                ...
                <div className="card-body">
                  ...
                  <a href="https://rozhinasaberi.github.io/ITEC3020a1/" className="btn btn-visitpage" target="_blank" rel="noreferrer">
                    Visit Shop
                  </a>
                </div>
              </div>
