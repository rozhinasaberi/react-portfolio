...
export default function App() {
  return (
    <>
      ...
      <header id="header" className="fixed-top">
        <nav className="navbar container">
          ...
          <a href="#home" className="navbar-brand d-flex align-items-center gap-2">
            <img src="logoname.png" alt="Rojina Logo" style={{ height: 40 }} />
            <span className="brand-text">Rojina</span>
          </a>
      ...
      {/* ===== Hero (full window, centered) ===== */}
      <section id="home" className="home">
        <div className="container h-100">
          <div className="row h-100 hero-row">
            {/* Photo LEFT */}
            <div className="col-lg-5 d-flex justify-content-center align-items-center order-1 order-lg-1">
              {/* Put your image in /public/picture.jpg or change the src below */}
              <img src="picture.jpg" alt="Rojina" className="hero-photo" />
            </div>

            {/* Text RIGHT */}
            <div className="col-lg-7 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start order-2 order-lg-2">
      ...
      {/* ===== About (centered, contrasting text) ===== */}
      <section id="about" className="aboutsection">
        <div className="container">
          <div className="about-card mx-auto">
            ...
            <a href="/resume.pdf" className="btn btn-visitpage">Resume</a>
          </div>
        </div>
      </section>
